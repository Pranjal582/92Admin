    ...
    <>
        <ContainerS>
            ...
            <Wrapper>
                ...
                <CardDetails>
                <h4>Parent's Name : <span> {name}</span> </h4>
                <h4>Child Name : <span> Child 1</span>   </h4>
                <h4>Phone No: <span> 9876543210</span> </h4>     
                <h4>Email : <span> {email} </span> </h4> 
                <h4> Valid From : <span> 22-02-2022</span> </h4> 
                <h4>Valid To: <span>22-08-2022</span> </h4> 
                <h4>Membership : <span> Gold</span> </h4>
                </CardDetails>
                <CardDetails>
                    <h4>Card Details</h4>
                  <h5>Name On Card :{nameoncard} </h5>
                  <h5 >Card Number : <p> {cardnumber} </p></h5>
                  <h5>Expiration  : <p> {expirydate} </p>      </h5>
                  <h5>CVV : <p> {cvv} </p>      </h5>
                </CardDetails>  
